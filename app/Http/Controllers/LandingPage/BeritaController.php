...
class BeritaController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('landingpage.berita.beritaall', compact('beritaData'));
    }
    ...
    public function show($slug)
    {
        ...
        $berita = collect($beritaData)->firstWhere('slug', $slug);
        ...
        return view('landingpage.berita.beritadetail', compact('berita'));
    }
