<div class="w-full mb-16  scroll-mt-6" id="berita">
    <div class="flex justify-between">
        ...
        <a href="/berita" class="font-bold text-sm py-3 px-6 rounded-lg shadow-md bg-blue-900 text-white mb-4">Semua
            Berita</a>
    </div>
...
<script>
    ...
    const beritaData = [{
        ...
        {
            imgSrc: "{{ asset('img/berita/berita1.png') }}",
        ...
        {
            imgSrc: "{{ asset('img/berita/berita2.jpg') }}",
        ...
        {
            imgSrc: "{{ asset('img/berita/berita3.jpg') }}",
        ...
        {
            imgSrc: "{{ asset('img/berita/berita4.jpg') }}",
    ...
    beritaData.forEach(berita => {
        // Potong description menjadi 150 karakter
        let shortDescription = berita.description.join(' ').slice(0, 200);
        let shortTitle = berita.title.slice(0, 100);

        // Tambahkan elipsis jika description lebih dari 150 karakter
        if (berita.description.join(' ').length > 200) {
            shortDescription += '...';
        }

        // Tambahkan elipsis jika title lebih dari 100 karakter
        if (berita.title.length > 100) {
            shortTitle += '...';
        }
