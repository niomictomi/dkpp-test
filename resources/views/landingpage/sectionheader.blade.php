    ...
    <div class="container px-4 md:px-16 flex flex-col md:flex-row justify-between items-center">
        <a href="/">
            <div class="flex flex-col md:flex-row items-center gap-4">
                <img src="{{ asset('img/logo.png') }}" alt="Hero Image" class="w-20 h-20 object-cover">
                <h1 class="text-xl font-bold text-center md:text-start">PENASIHAT KHUSUS PRESIDEN <br>BIDANG
                    POLITIK DAN KEAMANAN</h1>
            </div>
        </a>
        <nav class="mt-4 md:mt-0 ml-auto flex">
